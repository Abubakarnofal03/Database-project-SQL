...

{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string conStr = @"DATA SOURCE = localhost:1521/xe;USER ID=f219120;PASSWORD=wajeeha";
        ...
        private void updateGrid22()
        {
            con.Open();
            OracleCommand getEmps = con.CreateCommand();
            getEmps.CommandText = "SELECT * FROM event where event_id = "+de.Text.ToString();
            getEmps.CommandType = CommandType.Text;
            OracleDataReader empDR = getEmps.ExecuteReader();
            DataTable empDT = new DataTable();
            empDT.Load(empDR);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //button11.Location=new Point(199, 210);  
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            //eid.Text = "id";
            //eid.AutoSize = true;
            //eid.BackColor = Color.White;
            //eid.Location = new Point(69, 105);
            //this.Controls.Add(eid);

            //sid.Visible = true;

            //sid.AutoSize = true;
            //sid.BackColor = Color.White;
            //sid.Location = new Point(199, 100);
            //this.Controls.Add(sid);

            //status.Visible = true;
            //status.Text = "status";
            //status.AutoSize = true;
            //status.BackColor = Color.White;
            //status.Location = new Point(69, 155);
            //this.Controls.Add(status);
            //stf.Visible = true;

            //stf.AutoSize = true;
            //stf.BackColor = Color.White;
            //stf.Location = new Point(199, 150);
            //this.Controls.Add(stf);
    ...
    //        sp.AutoSize = true;
    //        sp.BackColor = Color.White;
    //        sp.Location = new Point(69, 155);
    //        this.Controls.Add(sp);
    //        sp1.Visible = true;

    //        sp1.AutoSize = true;
    //        sp1.BackColor = Color.White;
    //        sp1.Location = new Point(199, 150);
    //        this.Controls.Add(sp1);
    //    }
